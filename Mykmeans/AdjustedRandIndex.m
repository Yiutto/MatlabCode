...
% AdjustedRandIndex - calculates Rand Indices to compare two partitions
% ARI=AdjustedRandIndex(c1,c2), where c1,c2 are vectors listing the 
% class membership, returns the "Hubert & Arabie adjusted Rand index".
% [AR,RI,MI,HI]=AdjustedRandIndex(c1,c2) returns the adjusted Rand index, 
